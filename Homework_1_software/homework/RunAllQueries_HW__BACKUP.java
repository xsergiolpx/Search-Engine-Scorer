...
public class RunAllQueries_HW {
	...
	public static void main( String arg[] ) throws Exception {
		...
		if (arg.length != 5) {
			...
			System.out.println("   java homework.RunAllQueries_HW \"cran\" ./cran_all_queries.tsv \"TfIdfScorer\" \"1:2\" output_cran__NoStemmer__TfIdf.tsv");
			System.out.println();
			return;
		}
		...
		for (Map.Entry<Integer, String> entry : id_query.entrySet()) {
			...
			query = RunAllQueries_HW.create_disjunctive_query(c_query, filter_stopwords);
	...
	protected static String create_disjunctive_query(String input_query, boolean filter_stopwords) {
